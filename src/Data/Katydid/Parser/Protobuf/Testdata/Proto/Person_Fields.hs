...
module Data.Katydid.Parser.Protobuf.Testdata.Proto.Person_Fields where
...
address ::
        forall f s t a b . (Lens.Labels.HasLens f s t "address" a b) =>
          Lens.Family2.LensLike f s t a b
address
  = Lens.Labels.lensOf
      ((Lens.Labels.proxy#) :: (Lens.Labels.Proxy#) "address")
maybe'address ::
              forall f s t a b .
                (Lens.Labels.HasLens f s t "maybe'address" a b) =>
                Lens.Family2.LensLike f s t a b
maybe'address
  = Lens.Labels.lensOf
...
maybe'street ::
             forall f s t a b .
               (Lens.Labels.HasLens f s t "maybe'street" a b) =>
               Lens.Family2.LensLike f s t a b
maybe'street
  = Lens.Labels.lensOf
...
phoneNumbers ::
             forall f s t a b .
               (Lens.Labels.HasLens f s t "phoneNumbers" a b) =>
               Lens.Family2.LensLike f s t a b
phoneNumbers
  = Lens.Labels.lensOf
