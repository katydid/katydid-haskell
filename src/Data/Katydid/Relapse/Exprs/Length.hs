...
mkLengthExpr es = do
  ...
  case e of
    ...
    (AnyExpr _ (DoublesFunc _)) ->
      mkIntExpr . lengthListExpr <$> assertDoubles e
    (AnyExpr _ (StringsFunc _)) ->
      mkIntExpr . lengthListExpr <$> assertStrings e
    (AnyExpr _ (ListOfBytesFunc _)) ->
      mkIntExpr . lengthListExpr <$> assertListOfBytes e
    (AnyExpr _ (StringFunc _)) ->
      mkIntExpr . lengthStringExpr <$> assertString e
